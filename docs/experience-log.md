...
- [风险监控] 佛塑科技000973大股东质押（5月21日公告）需持续跟踪质押比例；株冶集团/四川黄金减持已完成或届满，属正常市场行为
- [八字] 第六课完成：81wav合并→2期第六课_完整.wav，whisper转录57212字
- [八字] 宫位分析法新发现：分析六亲不看对应十神旺不旺，而是看**宫位上的内容对十神的作用**。例：月柱=父亲宫位，看月柱上有什么十神，对偏财（父亲星）起什么作用（生/克/泄）。第五课案例：月柱辛金食神生癸水偏财→宫位帮父亲→心脏问题不严重
- [选股] 系统V3：评分和风险完全分离。风险是诊断工具不是门卫，只在对比最早历史记录时触发（评分掉≥5分）。判断逻辑：看具体哪个指标导致的，该指标本身是好是坏
...
- [飞书] 表格统一：第一池补充了N-T列（建议/开盘价/当前价/滑点），与第二池表头对齐。之前只写A-M列，导致两池结构不一致
- [八字] 六合合化条件研究：从第五课转录稿中找到关键信息——紧贴（相邻）力量大、隔位力量减半、合喜神得助力/合忌神是拖累、贪合忘冲。笔记中未明确讲六合"合化成功"条件（如是否需要天干透化神），可能后续课程才讲
